<template>
  ...
  <Title msg="Book: Reality Media" />
	<div xr-layer><div class="squareoff" style="width:380px">Published by <a href="https://mitpress.mit.edu/books/reality-media" target="_blank" class="alink">MIT Press</a></div></div>
  <br>
