<template>
  ...
  <br />
	<div class="squareoff"><em>Realitymedia</em> is built on top of Mozilla's open-source platform. An extensive guide to using Mozilla Hubs is available <div xr-layer ><a href="https://hubs.mozilla.com/docs/intro-hubs.html" target="blank" class="alink" >in the Hubs user documentation.</a></div><br><br>
