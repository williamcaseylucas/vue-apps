...
<br>
- For VR and mobile controls, see the list of <span class="alink"><a xr-layer href="https://hubs.mozilla.com/docs/hubs-controls.html" target="blank">Hubs controls.</a></span>
  </div>
  </div>
  </div> 
</div>
