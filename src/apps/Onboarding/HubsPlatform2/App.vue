...
<br>
- For VR and mobile controls, see the <span xr-layer class="test"><a href="https://hubs.mozilla.com/docs/hubs-controls.html" target="_blank">list of Hubs controls.</a></span>
 </div>
  </div>
  </div>
  </div> 
