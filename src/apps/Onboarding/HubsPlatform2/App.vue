...
<br>
- For VR and mobile controls, see the <a href="https://hubs.mozilla.com/docs/hubs-controls.html" target="_blank"><span xr-layer class="test">list of Hubs controls.</span></a>
 </div>
  </div>
  </div>
  </div> 
