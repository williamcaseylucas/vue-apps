...
<br>
- For VR and mobile controls, see the list of <span xr-layer><a href="https://hubs.mozilla.com/docs/hubs-controls.html" target="blank" class="alink">Hubs controls.</a></span>
  </div>
  </div>
  </div> 
</div>
